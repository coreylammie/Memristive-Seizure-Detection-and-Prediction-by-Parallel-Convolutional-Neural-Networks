...
void inference_routine_api(const mxArray *const prhs[15], const mxArray **plhs)
{
  ...
  inference_routine(*tile_1, *tile_2, *max_weight, n_kernels, *kernel_sizes,
                    *dense1a, *dense1b, *dense1c, *dense1d, *dense1e,
                    *dense1b_diff, *dense2b, *test_data, *test_labels,
                    n_samples, out);
...
void inference_routine_atexit()
{
  ...
  inference_routine_xil_terminate();
  inference_routine_xil_shutdown();
